...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-[max(5.25rem,calc(env(safe-area-inset-bottom)+4.5rem))] left-[max(1.25rem,env(safe-area-inset-left))] z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-105 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[color:var(--ink)] md:bottom-[max(1.25rem,env(safe-area-inset-bottom))]"
    >
